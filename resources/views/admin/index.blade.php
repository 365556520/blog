...
<body>
	...
	<div class="menu_box">
		<ul>
            <li>
                ...
                <ul class="sub_menu">
                    <li><a href="{{url('admin/catcgory/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加分类</a></li>
                    <li><a href="{{url('admin/catcgory')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>分类管理</a></li>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="http://www.blog.com">http://www.blog.com</a>.
	</div>
	<!--底部 结束-->
</body>
@endsection